            ...
            <div className="container mx-auto text-center px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {steps.map((step, index) => (
                        <div
                            key={index}
                            className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-xl transition duration-300"
                        >
                            <div className="text-4xl font-extrabold text-orange-600 dark:text-orange-400 mb-4">
                                {index + 1}
                            </div>
